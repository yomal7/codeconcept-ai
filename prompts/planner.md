...
- The video theme must be one of the supported themes only: `codeconcept` or `minimal`. Choose the one that best fits the topic and do not invent any other theme names.
